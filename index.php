...
<div id="main">
	...
	<div id="intro" style="display: none; position: absolute; width: 300px; height: 20px; left: 50%; z-index: 999; top: -5px">
	...
	<div id="share">
		<div id="sharingoptions">
			...
			<input rel="tooltip" type="text" class="form-control"
			       id="playlistcode" readonly="readonly" value="<?php echo (isset($_GET['id']) ? 'https://instadj.com/'.preg_replace("/[^a-zA-Z0-9\s]/", "", $_GET['id']) : '') ?>"
